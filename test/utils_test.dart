...
void main() {
  test('formatTimecode formats hms', () {
    expect(formatTimecode(const Duration(hours: 1, minutes: 2, seconds: 3)), '1h2m3s');
  ...
  test('sanitizeYouTubeUri keeps essential params', () {
    final u = Uri.parse('https://www.youtube.com/watch?v=abc123def45&t=30&fbclid=xyz&si=abc');
